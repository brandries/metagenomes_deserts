...
compare_genes_tax <- read.delim("~/Masters/Data 2017/blast scaffolds/Tsv files/comp_all_scaffolds_norm-phylum-filt0.01.txt", sep = "\t")

#order the figure - pur in the phyla in your own dataset
corr_order <- c("Other", "Acidobacteria", "Actinobacteria <phylum>", "Bacteroidetes", "Chloroflexi", "Cyanobacteria",
                "Firmicutes", "Gemmatimonadetes", "Planctomycetes", "Proteobacteria", "Thaumarchaeota")
corr_nam <- c("Other", "Acidobacteria",
              "Actinobacteria",
                "Bacteroidetes",
              "Chloroflexi",
              "Cyanobacteria",
...
filcols <- wes_palette("Darjeeling2", 11, type = c("continuous"))
filcols <- rainbow(12)
...
#plot in svg
svg(filename = "barplot_scaff_facet_fc.svg", width = 8, height = 4, pointsize = 12)
plot1
dev.off()
