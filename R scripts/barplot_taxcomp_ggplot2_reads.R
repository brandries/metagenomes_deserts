...
compare_genes_tax <- read.delim("~/Masters/Data 2017/blast reads/Tsv files/compare_reads_norm-phylum_filt0.01_r.txt", sep = "\t")
...
#plot in svg
svg(filename = "barplot_reads_facet_fc.svg", width = 8, height = 4, pointsize = 12)
plot1
dev.off()
